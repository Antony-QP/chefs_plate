...
paper_menu_picture = URI.open('https://i.pinimg.com/474x/1a/7d/ff/1a7dff3813150a4080eab22cef01ffba.jpg')
menu_1 = Menu.new({
...
menu_1.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_1.png', content_type: 'image/png')
menu_1.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/736x/b5/5e/ae/b55eae4cbb56e16ea50bd60918c0a09a.jpg')
menu_2 = Menu.new({
...
menu_2.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_2.png', content_type: 'image/png')
menu_2.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/originals/15/f6/19/15f61972261c3ea32b1339dae2234bbd.png')
menu_3 = Menu.new({
    title: "Summer menu",
    chefs_note: Faker::Lorem.sentence(word_count: 20),
    price: Faker::Number.decimal(l_digits: 2),
...
menu_3.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_3.png', content_type: 'image/png')
menu_3.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/originals/86/72/79/867279b09ad4cd09af709de51825372f.png')
menu_4 = Menu.new({
...
menu_4.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_4.png', content_type: 'image/png')
menu_4.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/originals/9b/2d/e5/9b2de504b88d0e10c08f260a3d2ea5cf.jpg')
menu_5 = Menu.new({
...
menu_5.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_5.png', content_type: 'image/png')
menu_5.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/474x/d1/8c/f4/d18cf4bf48c2686a00ee80b71ffb1abf.jpg')
menu_6 = Menu.new({
...
menu_6.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_6.png', content_type: 'image/png')
menu_6.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/originals/a3/36/92/a33692570fc1e850ba4f725c1d477009.jpg')
menu_7 = Menu.new({
    title: "July menu",
    chefs_note: Faker::Lorem.sentence(word_count: 20),
    price: Faker::Number.decimal(l_digits: 2),
...
menu_7.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_7.png', content_type: 'image/png')
menu_7.save!
...
paper_menu_picture = URI.open('https://cdn.vox-cdn.com/thumbor/z1XQ9An1ItIdq7IELvMtSmJ7UyI=/1400x0/filters:no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/20064045/unnamed__2_.png')
menu_8 = Menu.new({
...
menu_8.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_8.png', content_type: 'image/png')
menu_8.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/originals/74/35/d7/7435d7b12a801da46dab3f2fcad39fac.jpg')
menu_9 = Menu.new({
...
menu_9.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_9.png', content_type: 'image/png')
menu_9.save!
...
paper_menu_picture = URI.open('https://i.dailymail.co.uk/i/pix/2015/01/30/253146E500000578-2933093-image-a-21_1422626656093.jpg')
menu_10 = Menu.new({
...
menu_1.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_10.png', content_type: 'image/png')
menu_10.save!
...
paper_menu_picture = URI.open('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZNOMK4rHDmhk5BTN6s-rXYqWdj_BIWG0uHA&usqp=CAU')
menu_11 = Menu.new({
...
menu_11.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_11.png', content_type: 'image/png')
menu_11.save!
...
paper_menu_picture = URI.open('https://i.pinimg.com/236x/1a/7d/ff/1a7dff3813150a4080eab22cef01ffba.jpg')
menu_12 = Menu.new({
...
menu_12.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_12.png', content_type: 'image/png')
menu_12.save!
...
paper_menu_picture = URI.open('https://www.gotoaskanne.com/wp-content/uploads/2019/01/Marcos-kitchen-dinner-menu-1.jpg')
menu_13 = Menu.new({
...
menu_13.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_13.png', content_type: 'image/png')
menu_13.save!
...
menu_14.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_14.png', content_type: 'image/png')
menu_14.save!
...
paper_menu_picture = URI.open('https://thechosentable.files.wordpress.com/2018/12/magnolia-new-years-eve-dinner-2018-1.jpg?w=288&h=408')
menu_15 = Menu.new({
...
menu_15.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_15.png', content_type: 'image/png')
menu_15.save!
...
paper_menu_picture = URI.open('https://lh3.googleusercontent.com/proxy/Te3pNqOKCO70hvb5q4uneZHIewLekUgPER-x_-ZyuQFATfoozsrLY20BGKMTZjhHphdxY1UeQGxrCf-93tmBTO2OMP5gP1hF1MbYv2v69klLejKGN7pxMcue9bYnURJHYlwEss29RU4g-PazHA')
menu_16 = Menu.new({
    title: "Truffle Menu",
    chefs_note: Faker::Lorem.sentence(word_count: 20),
    price: Faker::Number.decimal(l_digits: 2),
...
menu_16.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_16.png', content_type: 'image/png')
menu_16.save!
...
paper_menu_picture = URI.open('https://laughfrodisiac.com//wp-content/uploads/2019/02/uploads1854185438681471876518.png')
menu_17 = Menu.new({
...
menu_17.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_17.png', content_type: 'image/png')
menu_17.save!
...
paper_menu_picture = URI.open('https://www.kilronancastle.ie/wp-content/uploads/2020/11/Ala-Carte-Vegan-Vegetarian.png')
menu_18 = Menu.new({
...
menu_18.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_18.png', content_type: 'image/png')
menu_18.save!
...
paper_menu_picture = URI.open('https://1.bp.blogspot.com/-RtO4VpSjMVM/XBIdFX517GI/AAAAAAAA2CQ/Y4i5touLaUAxrvLXXX85lI1i6wwXSS5QgCEwYBhgL/s1600/menu-SS-IL-TINO-LR-1.jpg')
menu_19 = Menu.new({
...
menu_19.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_19.png', content_type: 'image/png')
menu_19.save!
...
paper_menu_picture = URI.open('http://www.lacartes.com/images/business/38963/118039/m/284471.jpg')
menu_20 = Menu.new({
...
menu_20.photos.attach(io: paper_menu_picture, filename: 'paper_menu_picture_20.png', content_type: 'image/png')
menu_20.save!
